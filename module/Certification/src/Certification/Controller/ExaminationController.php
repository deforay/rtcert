    ...
    public function xlsAction() {
        ...
        if ($request->isPost()) {
            ...
            foreach ($examination as $examination) {
                ...
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $ligne, (isset($examination['region_name']))?$examination['region_name']:'');
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, $ligne, (isset($examination['district_name']))?$examination['district_name']:'');
